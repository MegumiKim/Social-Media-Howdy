export function userThumbnailTemplate(profile) {
  return `
  <a href="index.html?name=${profile.name}" class="list-group-item list-group-item-action py-3" aria-current="true">
  <img src="${profile.avatar}" alt="${profile.name}" class="bd-placeholder-img flex-shrink-0 me-2 rounded" width="32" height="32">
